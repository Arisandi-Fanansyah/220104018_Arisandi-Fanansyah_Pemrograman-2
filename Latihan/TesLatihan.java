package com.arisandif.pbo.modul5.Latihan;

import com.arisandif.pbo.modul5.Latihan.Perbankan.Nasabah;
import com.arisandif.pbo.modul5.Latihan.Perbankan.Tabungan;
...
public class TesLatihan {
    public static void main(String[] args) {
        ...
        nasabah.getTabungan().simpanUang(3500);System.out.println("Jumlah uang yang disimpan 3500");
        ...
        nasabah.getTabungan().simpanUang(2000);System.out.println("Jumlah uang yang disimpan 2000");
        tmp = nasabah.getTabungan().getSaldo();
